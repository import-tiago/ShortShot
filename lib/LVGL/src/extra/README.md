...
- Please and follow the [Coding style](https://github.com/import-tiago/lvgl/blob/master/docs/CODING_STYLE.md) of LVGL
- Add setter/getter functions in pair
- Update [lv_conf_template.h](https://github.com/import-tiago/lvgl/blob/master/lv_conf_template.h)
- Add description in the [docs](https://github.com/import-tiago/lvgl/tree/master/docs)
- Add [examples](https://github.com/import-tiago/lvgl/tree/master/examples)
- Update the [changelog](https://github.com/import-tiago/lvgl/tree/master/docs/CHANGELOG.md)
...
- New [Calendar headers](https://github.com/import-tiago/lvgl/tree/master/src/extra/widgets/calendar)
- Color picker with RGB and or HSV bars
- Ruler, horizontal or vertical with major and minor ticks and labels
- New [List items types](https://github.com/import-tiago/lvgl/tree/master/src/extra/widgets/list)
